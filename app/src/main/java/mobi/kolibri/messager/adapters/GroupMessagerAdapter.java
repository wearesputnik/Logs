 ...
 */
public class GroupMessagerAdapter extends ArrayAdapter<GroupMessagerInfo> {
    ...
    public GroupMessagerAdapter (Context context, String user_id_A) {
        super(context, 0);
        listItem = new ArrayList<GroupMessagerInfo>();
        contV = context;
        user_id = user_id_A;
    }

    public View getView(int position, View convertView, ViewGroup parent) {
        final GroupMessagerInfo item = getItem(position);
